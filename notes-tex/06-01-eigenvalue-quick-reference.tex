...
\input{../templates/exam-note-template.tex}
...
\labelnote{Core idea}{Eigenvectors are directions that survive multiplication by \(A\). The matrix only stretches, shrinks, reverses, or rotates through a scalar factor.}
